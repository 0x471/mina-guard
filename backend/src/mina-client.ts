...
/**
 * Fetches block identities for the daemon's current bestChain, ordered
 * ascending by height. Used by the reorg-detection path to compare stored
 * BlockHeader hashes against the node's authoritative canonical view.
 */
